...
//recuperer les ventes de chaque utilisateur pour l'admin
public static function getVentesByUser($connexion, $user_id){
    $sql = "SELECT * FROM ventes WHERE user_id = :user_id ORDER BY date_vente DESC";
